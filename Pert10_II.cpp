...
void print_menu (WINDOW *menu_win, int pilihanTerpilih, const char *opsi[], int jmlhOpsi);
    ...
    int main(){
        ...
        WINDOW *menu_win=newwin(tinggi, lebar, awalX, awalY);
        keypad(menu_win,TRUE);

        const char *opsi[]= {
            "Pilihan 1", "Pilihan 2", "Pilihan 3", "Keluar"
        };
